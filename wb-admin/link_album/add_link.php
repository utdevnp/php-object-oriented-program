    	...
    	<div align="right">
		<h2 style="float:left; margin-left:5px; background:url(graphics/addnew/Link-icon.png) no-repeat; text-indent:40px; Padding:5px;">Links Management >> Add New </h2>
...
if(isset($_POST['add_video_button']))
{
	...
	else
	{
		...
		$result = $Link_Album-> add($parent_id,$name,$is_active,$description);
	
		if($result==1)
		{
			header("Location: index.php?folder=link_Album&file=list_link.php&msg=Added Successfully!");
			?>
