    	...
    	<div align="right">
		<h2 style="float:left; margin-left:5px; background:url(graphics/addnew/Link-icon.png) no-repeat; text-indent:40px; Padding:5px;">Links Management >> Edit </h2>
...
if(isset($_POST['edit_video_button']))
{
	...
	$result = $Link_Album->update($id,$name,$parent_id,$is_active,$description);

	if($result==1)
	{
		header("Location: index.php?folder=link_album&file=list_link.php&msg= Update Successfully!");
		?>
