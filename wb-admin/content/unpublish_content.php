...
<?php
	...
	{
		$delete_result = $Content->unpublish($_GET['id']);	
		if($delete_result==1)
		{
			$group_id = $_GET['group_id'];
			header("Location:index.php?folder=content&file=list_content.php&group_id=$group_id&sub=$sub&message=Unpublished-Succesfully!");
		}
		else
		{
