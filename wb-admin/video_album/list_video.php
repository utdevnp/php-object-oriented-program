...
<div>
	<div align="right">
		<h2 style="float:left; margin-left:5px; background:url(graphics/addnew/video_icon.gif)no-repeat; text-indent:40px; Padding:9px;">Videos Management</h2>
...
<table border="0"  align="left" cellspacing="0" width="100%"  cellpadding="5" id="content_table">
    <thead>
        <tr>
            ...
            <th>Active</th>
			 <th> &dArr; </th>
            <th colspan="6"><a href="index.php?folder=video_album&file=add_video.php"><strong title=" Click Here To Add New Gallery" >Add New Gallery</strong></a></th>
        </tr>
    </thead>
    <tbody>
	<?php
	...
	<?php
		...
		?>
			<tr>	
				...
				<td> 
					<?php echo ($row['parent_id']==0)?"SELF" : $Video->getNameById($row['parent_id']);?>
                </td>
				...
				<td> 
					<a href="index.php?folder=video&file=list_videos.php&video_id=<?php echo $row['id'];?> "> 
						 Videos
                    </a>
                </td>
                		
               	<td> <a href="index.php?folder=video_album&file=view_video.php&id=<?php echo $row['id'];?>">
                ...
                <td> 
					<a href="index.php?folder=video_album&file=edit_video.php&id=<?php echo $row['id'];?>"> 
                ...
                <!--td> 
					<a href="index.php?folder=video_album&file=delete_video.php&id=<?php //echo $row['id'];?>"> 
