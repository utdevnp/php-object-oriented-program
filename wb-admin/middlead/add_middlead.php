...
if(isset($_POST['add_video_button']))
{
	...
	$error.=$Validator->validate_text_range($name,5,50,"Full Name");
	...
	else
	{
		...
		$result = $Middlead-> add($parent_id,$name,$is_active,$description);
	
		if($result==1)
		{
			header("Location: index.php?folder=middlead&file=list_middlead.php&msg=Added Successfully!");
			?>
...
<div class="form_area">
	...
	<div style="clear:both;"></div>
	 ...
	 <div align="right">
		<h2 style="float:left; margin-left:5px; background:url(graphics/addnew/downloads.gif) no-repeat; text-indent:40px; Padding:5px;">Download Manager >> Add</h2>
