...
<div class="form_area">
	...
	?> 
<div align="right">
		<h2 style="float:left; margin-left:5px; background:url(graphics/addnew/gallery_icon.gif) no-repeat; text-indent:40px; Padding:5px;">Gallery Management >> View Gallery</h2>
	...
	<form method="post" class="">
				...
				<div class="form_item">
    				...
    				<div class="form_field">
    					<a href="index.php?folder=photos&file=edit_photos.php&id=<?php echo $_GET['id'];?>">Edit</a>  | 	<a href="index.php?folder=gallery&file=delete_gallery.php&id=<?php echo $_GET['id'];?>">Delete</a>
   		 			</div>
				</div>
