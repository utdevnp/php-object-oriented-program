...
<?php
$id = $_GET['id'];
$pre_result = $departure -> getById($id);
...
if(isset($_POST['add_video_button']))
{
	...
	else
	{
		...
		$result = $departure->update($id,$group_id,$departure_date,$price,$offered_price,$status,$remarks);
	
		if($result==1)
		{
			header("Location: index.php?folder=departure&file=all_list.php&id=$group_id&msg=Added Successfully!");
			?>
	...
	<form method="post"  class="niceform">
		    ...
		    <div class="form_item">
    				...
    				<div class="form_field">
						...
						<option value="<?php echo $group_row['id']; ?>" selected><?php echo $group_row['menu_name']; ?></option>
            	...
            	<div class="form_item">
    				...
    				<div class="form_field">
    				<input type="text" name="departure_date" value="<?php echo $pre_row['departure_date']; ?>" />
   		 			</div>
			</div>
            	<div class="form_item">
  					<div class="form_label">
    				...
    				<div class="form_field">
    				<input type="text" name="price" value="<?php echo $pre_row['price']; ?>" />
   		 			</div>
			</div>
			...
			<div class="form_item">
    				...
    				<div class="form_field">
    				<input type="text" name="offered_price" value="<?php echo $pre_row['offered_price']; ?>" />
   		 			</div>
			</div>
			...
			<div class="form_item">
    				...
    				<div class="form_field">
    				<select name="status">
					<option><?php echo $pre_row['status']; ?></option>
