...
<?php
	if(isset($_POST['edit_groups_button']))
	{
		...
		else
		{
				...
				$result =$Group->edit($id,$name,$howmany,$order_by,$parent_id,$is_active);
				if($result==1)
				{
					header("Location: index.php?folder=group&file=list_group.php&message=Record Updated Successfully!");
				}
				else
				{
...
<div style="display:none;" class="form_item">
        ...
        <div class="form_field">
			<select name="parent_id">
                ...
                <?php
					$parent_list = $Group->listParent($_GET['parent_id']);
