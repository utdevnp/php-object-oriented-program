		...
		<h2 style="float:left; margin-left:5px; background:url(graphics/addnew/Link-icon.png) no-repeat; text-indent:40px; Padding:5px;">Altitude Management </h2>
		 ...
		 <a style="float:right;  margin-right:10px;" href="index.php?folder=altitude&file=add_altitude.php"><img src="graphics/addnew/add.png" height="40" width="40"  alt="Go Back" title="Click Here To Add New Group"  /></a> 
	</div>
...
<table border="0"  align="left" cellspacing="0" width="100%"  cellpadding="5" id="content_table">
    <thead>
        <tr>
            ...
            <th>Category</th>
			<th>No. of Altitude</th>
       
			 
            <th colspan="6"><a href="index.php?folder=altitude&file=add_altitude.php"><strong title=" Click Here To Add New Gallery" >Add New Group</strong></a></th>
        </tr>
    </thead>
    <tbody>
	<?php
	//get all record from gallery table
		$result = $Altitude->getAllByGrp();
	?>
		<div class="record">
			<?php
		...
		?>
			<tr>	
				...
				<td> 
					...
					$ttlNum = $Altitude -> getConByGrop($row['group_id']);
               	...
               	<td> <a href="index.php?folder=altitude&file=all_list.php&id=<?php echo $row['group_id'];?>">
